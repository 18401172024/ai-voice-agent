...
import { ArrowLeft, Calendar, Copy, List, Plus } from 'lucide-react';
    ...
    <div className='flex flex-col items-center justify-center mt-10'>
      ...
      <div className='w-full p-7 mt-6 rounded-lg bg-white'>
        ...
        <div className='flex gap-5'>
          <h2 className='text-sm text-gray-500 gap-2 items-center'><Clock className='h-4 w-4'/> {formData?.duration}</h2>
          <h2 className='text-sm text-gray-500 gap-2 items-center'><List className='h-4 w-4'/> 10 Questions </h2>
        </div>
      </div>
