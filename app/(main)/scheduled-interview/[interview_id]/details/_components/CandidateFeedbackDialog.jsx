...
function CandidateFeedbackDialog({candidate}) {
  ...
  return (
    <Dialog>
  <DialogTrigger asChild><Button variant='outline' className="text-primary">View Result</Button></DialogTrigger>
  <DialogContent>
    <DialogHeader>
      ...
      <DialogDescription asChild>
        <div className='mt-5'>
          ...
          <div className={`p-5 rounded-md ${feedback?.Recommendation=='No'?'bg-red-100':'bg-green-100'}`}>
